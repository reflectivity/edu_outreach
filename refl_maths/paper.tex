...
\section{Contrast variation/resonant reflectometry}
Contrast variation is an important tools in neutron reflectometry \cite{bohm_probing_2019,clifton_self_2019}, while the use of resonant X-ray reflectometry may be utilised in the study of magnetic or ferroelectric materials \cite{kemik_resonant_2011}. 
These techniques differ significantly in the practical experimental methodology, however there is substantial overlap in their analysis. 
In theory, both methods enable the ability to measure identical structural samples with variations in the scattering lengths of the components. 
