...
\begin{abstract}
Reflectometry analysis is an inherently ill-posed problem; the well known phase problem leads to different structures whose scattering signals are very similar.
