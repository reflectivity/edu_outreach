...
%ARM Do you mean something like the $|k_i|\sin{\theta} = |k_f|\sin{\theta} = \frac{2\pi}\sin{\theta} = \frac{|\mathbf{q}|}{2} = \frac{q}{2}$ as a why of explaining what the $q$-vector is? I agree that it is necessary to explain what $q$ is but how about we just give the $q = \frac{4\pi\sin{\theta}}{\lambda} and explain that a full derivation can be found elsewhere \cite{sivia_elementary_2011}
\begin{equation}
